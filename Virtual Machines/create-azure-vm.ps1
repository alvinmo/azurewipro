...
$dnsName    = ""  #write globally unique name
$saName     = "" #storage account name for OS disk
$location   = ""  #location name of storage account
...
$rgVNETName = ""  #existing resource group name
...
$ipName     = "" #write new name ip
$nicName    = "" #write new name nic
$vmName     = "" #write new name vm
$vmSize     = "Standard_F1" #STANDARD_CAN_NOT_BE_CHANGED
$nsgName    = "" #existing nsg name
$avSet      = "" #existing avset name
...
$skuName    = "Web"
$nicName    = "" #write new nic name 
$vmName     = "" #write new vm name for sql server
